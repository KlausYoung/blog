...
<div id="saveEmpDiv" style="display: none;margin-top: 20px;">
    <form class="layui-form" action="" id="saveEmpForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input my_date" name="hiredate" id="hiredate" lay-verify="required|hiredate" placeholder="yyyy-MM-dd" autocomplete="off">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="deptno" id="saveDept" lay-verify="required|deptno"></select>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit lay-filter="saveEmp">添加</button>
