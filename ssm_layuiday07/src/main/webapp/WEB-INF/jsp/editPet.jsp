...
<body>
<!--隐藏修改的div-->
<div id="updPetDiv" style="display: none;margin-top: 20px;">
    <form class="layui-form" action="" lay-filter="updPetFormFilter" id="updPetForm">
        <!--员工主键petid-->
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="breedid" id="updBreed" lay-verify="required|breedid"></select>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit lay-filter="editPetInfo">修改</button>
