...
<div id="updEmpDiv" style="display: none;margin-top: 20px;">
    <form class="layui-form" action="" lay-filter="updEmpFormFilter" id="updEmpForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="hiredate" id="hiredate" lay-verify="required|hiredate" placeholder="请输入员工入职时间" autocomplete="off" class="layui-input my_date">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="deptno" id="updDept" lay-verify="required|deptno"></select>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit lay-filter="editEmp">修改</button>
